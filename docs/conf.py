# -*- coding: utf-8 -*-
#
# pytest-fauxpy documentation build configuration file, created by
...
project = 'pytest-fauxpy'
copyright = '2015, AuthorFn AuthorLn'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-fauxpy Documentation',
     [author], 1)
]
